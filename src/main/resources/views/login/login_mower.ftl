...
<body data-base="${base}">
	...
	<#if exception?exists && !(RequestParameters.form)?exists>
		<script type="text/javascript">
			...
			window.location = '${maculaConfig.getCasServerService()}/logout?service=${maculaConfig.getCasClientService()}/logout&forward=/admin';
		</script>
	</#if>	
	...
	<#if !(RequestParameters.form)?exists && !exception?exists>
		<script type="text/javascript">
			function checkCasLogin(status) {
				window.location = '${maculaConfig.getCasServerService()}/login?service=${maculaConfig.getCasClientService()}/login/cas<#if (RequestParameters.forward)?exists>&forward=${RequestParameters.forward}</#if>&form=${maculaConfig.getCasClientService()}/login';
			}
		</script>	
                    ...
                    <div class="login-panel">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="pwdlogin">
                                <!-- BEGIN LOGIN FORM -->
                                <form id="login-form" class="login-form" action="${base}/login/check?form=true&forward=<#if (RequestParameters.forward)?exists>${RequestParameters.forward}<#else>/</#if>" method="post">
                            		<#if exception?exists >
